...
namespace FinalProject {
    ...
    public partial class StoreDBDataSet3 : global::System.Data.DataSet {
        ...
        public partial class ITEMDataTable : global::System.Data.TypedTableBase<ITEMRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ITEMRow AddITEMRow(string ItemDescription) {
        ...
        public partial class PURCHASEDataTable : global::System.Data.TypedTableBase<PURCHASERow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PURCHASERow AddPURCHASERow(int CustID, int ItemID, int Qty, decimal OrderTotal) {
...
namespace FinalProject.StoreDBDataSet3TableAdapters {
    ...
    public partial class ITEMTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ItemDescription FROM dbo.ITEM";
        ...
        public virtual int Fill(StoreDBDataSet3.ITEMDataTable dataTable) {
        ...
        public virtual StoreDBDataSet3.ITEMDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StoreDBDataSet3.ITEMDataTable dataTable = new StoreDBDataSet3.ITEMDataTable();
    ...
    public partial class PURCHASETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PURCHASE] WHERE (([PurchaseID] = @Original_PurchaseID) AND ([C" +
                "ustID] = @Original_CustID) AND ([ItemID] = @Original_ItemID) AND ([Qty] = @Origi" +
                "nal_Qty) AND ([OrderTotal] = @Original_OrderTotal))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PURCHASE] ([CustID], [ItemID], [Qty], [OrderTotal]) VALUES (@C" +
                "ustID, @ItemID, @Qty, @OrderTotal);\r\nSELECT PurchaseID, CustID, ItemID, Qty, Ord" +
                "erTotal FROM PURCHASE WHERE (PurchaseID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PURCHASE] SET [CustID] = @CustID, [ItemID] = @ItemID, [Qty] = @Qty, [OrderTotal] = @OrderTotal WHERE (([PurchaseID] = @Original_PurchaseID) AND ([CustID] = @Original_CustID) AND ([ItemID] = @Original_ItemID) AND ([Qty] = @Original_Qty) AND ([OrderTotal] = @Original_OrderTotal));
SELECT PurchaseID, CustID, ItemID, Qty, OrderTotal FROM PURCHASE WHERE (PurchaseID = @PurchaseID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT PurchaseID, CustID, ItemID, Qty, OrderTotal FROM dbo.PURCHASE";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(StoreDBDataSet3.PURCHASEDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual StoreDBDataSet3.PURCHASEDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StoreDBDataSet3.PURCHASEDataTable dataTable = new StoreDBDataSet3.PURCHASEDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StoreDBDataSet3.PURCHASEDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PurchaseID, int Original_CustID, int Original_ItemID, int Original_Qty, decimal Original_OrderTotal) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_OrderTotal));
        ...
        public virtual int Insert(int CustID, int ItemID, int Qty, decimal OrderTotal) {
        ...
        public virtual int Update(int CustID, int ItemID, int Qty, decimal OrderTotal, int Original_PurchaseID, int Original_CustID, int Original_ItemID, int Original_Qty, decimal Original_OrderTotal, int PurchaseID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CustID, int ItemID, int Qty, decimal OrderTotal, int Original_PurchaseID, int Original_CustID, int Original_ItemID, int Original_Qty, decimal Original_OrderTotal) {
            return this.Update(CustID, ItemID, Qty, OrderTotal, Original_PurchaseID, Original_CustID, Original_ItemID, Original_Qty, Original_OrderTotal, Original_PurchaseID);
        }
    }
