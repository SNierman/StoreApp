...
namespace FinalProject {
    ...
    public partial class StoreDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class PURCHASEDataTable : global::System.Data.TypedTableBase<PURCHASERow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PURCHASERow AddPURCHASERow(int CustID, int ItemID, int Qty) {
...
namespace FinalProject.StoreDBDataSet1TableAdapters {
    ...
    public partial class PURCHASETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PURCHASE] ([CustID], [ItemID], [Qty]) VALUES (@CustID, @ItemID" +
                ", @Qty);\r\nSELECT PurchaseID, CustID, ItemID, Qty FROM PURCHASE WHERE (PurchaseID" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PURCHASE] SET [CustID] = @CustID, [ItemID] = @ItemID, [Qty] = @Qty WHERE (([PurchaseID] = @Original_PurchaseID) AND ([CustID] = @Original_CustID) AND ([ItemID] = @Original_ItemID) AND ([Qty] = @Original_Qty));
SELECT PurchaseID, CustID, ItemID, Qty FROM PURCHASE WHERE (PurchaseID = @PurchaseID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PurchaseID, CustID, ItemID, Qty FROM dbo.PURCHASE";
        ...
        public virtual int Fill(StoreDBDataSet1.PURCHASEDataTable dataTable) {
        ...
        public virtual StoreDBDataSet1.PURCHASEDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StoreDBDataSet1.PURCHASEDataTable dataTable = new StoreDBDataSet1.PURCHASEDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StoreDBDataSet1.PURCHASEDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PurchaseID, int Original_CustID, int Original_ItemID, int Original_Qty) {
        ...
        public virtual int Insert(int CustID, int ItemID, int Qty) {
        ...
        public virtual int Update(int CustID, int ItemID, int Qty, int Original_PurchaseID, int Original_CustID, int Original_ItemID, int Original_Qty, int PurchaseID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CustID, int ItemID, int Qty, int Original_PurchaseID, int Original_CustID, int Original_ItemID, int Original_Qty) {
            return this.Update(CustID, ItemID, Qty, Original_PurchaseID, Original_CustID, Original_ItemID, Original_Qty, Original_PurchaseID);
        }
    }
